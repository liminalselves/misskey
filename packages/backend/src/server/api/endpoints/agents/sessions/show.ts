...
export const meta = {
	...
	res: {
		...
		properties: {
			...
			randomProactiveMinSilenceMinutes: { type: 'integer', nullable: true },
			randomProactiveMaxWindowMinutes: { type: 'integer', nullable: true },
			randomProactiveDaytimeWeight: { type: 'integer', nullable: true },
			randomProactiveRecencyBias: { type: 'integer', nullable: true },
