			...
			recentLogs: {
				...
				items: {
					...
					properties: {
						...
						promptCacheHitTokens: { type: 'integer', nullable: true },
						promptCacheMissTokens: { type: 'integer', nullable: true },
	...
	constructor(
		...
		super(meta, paramDef, async (ps, me) => {
			...
			const recentLogs = recentLogsRaw.map(log => ({
				...
				promptCacheHitTokens: log.promptCacheHitTokens ?? null,
				promptCacheMissTokens: log.promptCacheMissTokens ?? null,
