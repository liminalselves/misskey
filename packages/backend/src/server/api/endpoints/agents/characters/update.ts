...
import { AgentService, AGENT_TEXT_FIELD_MAX, AGENT_EXAMPLE_TURN_CONTENT_MAX, AGENT_RULE_MAX, AGENT_RULE_CONTENT_MAX, AGENT_RULE_NAME_MAX, AGENT_RULE_DESC_MAX, type AgentWorldbookEntry } from '@/core/AgentService.js';
