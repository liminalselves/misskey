...
export const meta = {
	...
	errors: {
		...
		protectedFolder: {
			message: 'This folder only accepts files generated by AI agents.',
			code: 'PROTECTED_FOLDER',
			id: 'c8e7400d-72fd-4f9f-9c31-2d9563c9577d',
		},
	},
} as const;
	...
	constructor(
		...
		super(meta, paramDef, async (ps, me, _, file, cleanup, ip, headers) => {
			...
			try {
				...
				if (err instanceof DriveService.ProtectedFolderError) {
